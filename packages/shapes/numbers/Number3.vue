  ...
  <ShapeBase :shapeName="shapeId" v-bind="$props">
    <g :clipPath="`url(#${clipId})`">
      ...
      >
        <path
          fill="#fff"
          d="M10 0v70h25v60H10v70h125c30.376 0 55-24.624 55-55 0-18.602-9.234-35.046-23.369-45C180.766 90.046 190 73.602 190 55c0-30.376-24.624-55-55-55H10z"
        ></path>
      </mask>
      <g :mask="`url(#${maskId})`">
        ...
        <g filter="url(#filter0_f_880_3323)">
          <ellipse
            ...
            rx="54.993"
            ry="57"
            transform="rotate(-33.875 145.429 29.977)"
          ></ellipse>
